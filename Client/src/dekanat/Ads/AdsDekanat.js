import {GetDirections, GetFaculties, GetMessages, AddMessage} from '../../data/dekanatHelper';
...
function AdsDekanat() {
  ...
  function addMessage(theme, text){
    ...
    AddMessage(message).then(result=>GetMessages().then(data=>setMessages(data)));
  }
